    ...
    const reserve = async () => {
        ...
        try {
            ...
            if (booking.status === "PENDING") {
                setModalMessage("The booking's already occupied and your booking is added to the wishlists. When the guest cancels the trip, we will send you a notification through email.");
                setModalIsOpen(true);
            } else {
                navigate({
                    pathname: "/pay",
