            ...
            <Box flex={1} padding={3}>
                ...
                {activeSection === 'all-sites' && (
                    <Box>
                        ...
                        {sites.map((site) => (
                            <Box key={site.id} display="flex" alignItems="center" justifyContent="space-between" p={2}
              ...
              <Table>
                ...
                {activeSection === 'coupons' && (
                    <Box>
                        ...
                        {coupons.map((coupon) => (
                            <Box key={coupon.id} display="flex" alignItems="center" justifyContent="space-between" p={2}
                                 borderBottom="1px solid #e0e0e0">
                                <Typography variant="body1">Code: {coupon.code} - {coupon.discountRate}%
                                    off</Typography>
                                <Button
                                    variant="outlined"
                                    color="error"
